...
/**
 * The Class Tuning. Maintains an array which gives a note corresponding to
 * a particular frequency.
 */
public class Tuning {
	
	/** The Constant notesArray. */
	...
	/**
	 * Inits the note map. Initializes the musical notes according to frequency.
	 * The notes range from C2 to B6.
	 */
	...
	/**
	 * Gets the note. Gets the note according to the frequency of the musical note.
	 * We used an array instead of a we performed a binary search instead of hashing to find the
	 * closest note to a given frequency.
	...
	/**
	 * Gets the note by name.
	 *
	 * @param name the name
	 * @return the note by name
	 */
